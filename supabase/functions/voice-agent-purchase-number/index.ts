// supabase/functions/voice-agent-purchase-number/index.ts
// Purchase/order a phone number from Telnyx
...
serve(async (req) => {
  ...
  try {
    ...
    console.log('📞 Purchasing phone number:', formattedNumber);
    ...
    // Store the purchased number in database (optional - create a table for purchased numbers)
    // For now, just return the number - it can be used immediately
