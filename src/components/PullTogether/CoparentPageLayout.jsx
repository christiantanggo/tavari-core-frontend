...
export default function CoparentPageLayout({ children }) {
  return (
    <div
      style={{
        minHeight: '100vh',
    ...
    >
      ...
      <footer style={{ maxWidth: 720, margin: '0 auto', padding: '0 24px 40px', textAlign: 'center' }}>
        <div style={{ display: 'flex', flexWrap: 'wrap', justifyContent: 'center', gap: 8, marginBottom: 12 }}>
          <Link to="/coparent-app/privacy" style={footerLinkStyle}>
            Privacy
          </Link>
          <span style={{ color: COLORS.body }}>·</span>
          <Link to="/coparent-app/terms" style={footerLinkStyle}>
            Terms
          </Link>
          <span style={{ color: COLORS.body }}>·</span>
        ...
        <p style={{ margin: 0, fontSize: 13, color: COLORS.body, lineHeight: 1.5 }}>
          Pull Together: Co-Parent is not legal advice and is not a substitute for a court order.
        </p>
      </footer>
    </div>
  );
