// ColorsTab component for Settings screen
// Duplicates color configuration from AppBuilderBrandingTab, using same app_branding table
import React from 'react';
import AppBuilderColorPicker from '../AppBuilder/AppBuilderColorPicker';
...
const ColorsTab = ({ brandingData, setBrandingData, canEdit }) => {
  return (
