// components/VoiceAgent/AgentMessages.jsx
// Callback messages captured from voice agent calls when AI can't make booking
...
const AgentMessages = ({ businessId, voiceAgentService }) => {
        ...
        messages.map(message => (
          <div key={message.id} style={styles.messageCard}>
            <div style={styles.messageHeader}>
              <div>
                <div style={styles.messageName}>{message.caller_name || 'Unknown Caller'}</div>
                <div style={styles.messageInfo}>
                  {message.caller_phone && (
                    <a 
                      href={`tel:${message.caller_phone}`}
                  ...
                  {message.confidence_level && (
                    <div style={{ fontSize: '11px', color: TavariStyles.colors.gray500 }}>
                      AI Confidence: {message.confidence_level}%
                    </div>
                  )}
                </div>
              </div>
