// components/VoiceAgent/AgentAnalytics.jsx
// Analytics dashboard for voice agents
import React, { useState, useEffect } from 'react';
import { BarChart3, Phone, Clock, TrendingUp, Users } from 'lucide-react';
import { TavariStyles } from '../../utils/TavariStyles';
import toast from 'react-hot-toast';

const AgentAnalytics = ({ businessId, voiceAgentService }) => {
  ...
  const loadAnalytics = async () => {
    try {
      ...
      const [analyticsData, callsData] = await Promise.all([
        voiceAgentService.getAnalytics(null, dateRange),
        voiceAgentService.getCalls(null, { ...dateRange, limit: 50 }),
      ]);
