-- Drop and recreate scheduling_break_tracking table with correct foreign key
DROP TABLE IF EXISTS scheduling_break_tracking CASCADE;

CREATE TABLE scheduling_break_tracking (
