-- ============================================================================
-- Music V2 Module - Simple Fix for RLS Policies
-- ============================================================================
-- This ONLY fixes the admin policies that use FOR ALL (which conflicts)
-- Run this AFTER the initial create_rls_policies.sql has been run
-- ============================================================================

-- Drop the problematic FOR ALL policies (if they exist)
...
-- Also drop any incorrectly named ones that might exist
...
-- Ad Campaigns (only UPDATE and DELETE, INSERT is handled by advertiser policy)
