-- OTWK London: expose bookable party tiers + private rental via tavari-api-party-packages.
-- Run after setup-otwk-legacy-party-activities.mjs (Ultimate Birthday Party must exist).

-- Public bookable tiers: Classic / Super / Ultimate (10/20/30 kids & adults)
...
-- Private facility rental (inventory-only package, no public bookable activity)
UPDATE public.pos_inventory SET
  website_show_party_package = true,
